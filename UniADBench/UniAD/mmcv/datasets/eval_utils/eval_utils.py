...
def load_gt(nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False, category_convert_type='detection_category', data_infos=None):
    """
    ...
    :param verbose: Whether to print messages to stdout.
    :param data_infos: Optional data_infos to filter samples by their tokens.
    :return: The GT boxes.
    """
