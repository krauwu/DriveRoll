...
if __name__ == '__main__':
    ...
    parser.add_argument('--predroot', default='<path-to-results.pkl>', help='Path to results.pkl')
    parser.add_argument('--out_folder', default='<path-to-output-folder>', help='Output folder path')
