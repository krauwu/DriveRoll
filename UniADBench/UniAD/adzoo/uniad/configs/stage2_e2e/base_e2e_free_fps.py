...
### planning ###
planning_steps = 6
# gt_planning_steps = 6  # commented out frame-skipping parameter - restored official code
use_col_optim = True
...
# 12Hz data path (converted UniAD compatible format)
info_root = "<path-to-local-resource>"
file_client_args = dict(backend="disk")
ann_file_train=info_root + f"nuscenes_interp_12Hz_infos_train_uniad.pkl"
ann_file_val=info_root + f"nuscenes_interp_12Hz_infos_val_uniad.pkl"
# Test data
ann_file_test="<path-to-local-resource>"
...
data = dict(
    ...
    train=dict(
        ...
        predict_steps=predict_steps,
        planning_steps=planning_steps,
        # gt_planning_steps=gt_planning_steps,  # commented out frame-skipping parameter - restored official code
        past_steps=past_steps,
        fut_steps=fut_steps,
        use_nonlinear_optimizer=use_nonlinear_optimizer,
    ...
    test=dict(
        ...
        classes=class_names,
        modality=input_modality,
        # Skip tracking evaluation after slicing data (too few samples, tracking needs complete scene)
        eval_mod=['det', 'map', 'motion'],
    ),
